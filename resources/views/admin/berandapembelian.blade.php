        ...
        <div class="shadow px-6 py-4 bg-white rounded sm:px-2 sm:py-1 sm:br-gray-100">
          <div class="grid grid-cols-12">
            <div class="col-span-6 p-4">
              <a href="{{route('pembelian.create')}}"><button class="px-4 py-1 text-sm rounded text-purple-600 font-semibold border border-purple-200
              ...
              hover:text-white hover:bg-purple-600 hover:border-transparent focus:outline-none">cek<button></a>
                <a href=""><button class="px-4 py-1 text-sm rounded text-purple-600 font-semibold border border-purple-200
            ...
            @foreach ($pembelian as $item)
              <tr>
                    ...
                    <td>
                        ...
                        @csrf
                        @method('DELETE')
                         <a href="{{route('pembelian.edit',$item->id)}}" class="btn btn-xs p-2 rounded bg-green-200 m-3 hover:bg-blue hover:text-blue-900">Edit</a>
